...
class A{
    ...
    public void add(){
        try{System.out.println("Enter 1st no. :");
        x=s.nextDouble();
    ...
    public void subtract(){
       try{ System.out.println("Enter 1st no. :"+x);
        x=s.nextDouble();
    ...
    public void multiply(){
        ...
        System.out.println(x*y);}catch(Exception e){
    ...
    public void expo(){
      try { System.out.println("Enter a no. :");
       x=s.nextDouble();
...
class B  {
    double x,y;
    public void temp(){
     try{  try (Scanner s = new Scanner(System.in)) {
...
class C {
    ...
    public void currency(){
       ...
       try{ System.out.println("Enter your choice :-");
        System.out.println("Convert Ruppee to Dollar -");
        System.out.println("Convert Dollar to Ruppee -");
        try (Scanner sc = new Scanner(System.in)) {
            int choice =sc.nextInt();

            switch(choice) {
    
            case 1: System.out.println("Enter ruppee amount : ");
                    int R=sc.nextInt();
                    int x=R/82 ;
                    System.out.println("Dollar is :"+x);

            case 2: System.out.println("Enter dollar amount : ");
                    int D=sc.nextInt();
                    int y=D*82;
